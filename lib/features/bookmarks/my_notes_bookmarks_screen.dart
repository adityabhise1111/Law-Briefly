...
class _MyNotesBookmarksScreenState extends ConsumerState<MyNotesBookmarksScreen>
  ...
  void _setupAnimations() {
    ...
    _segmentFade = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
        parent: _entranceController,
        ...
        children: [
                ...
                child: SlideTransition(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(AppSpacing.xl,
                        AppSpacing.base, AppSpacing.xl, AppSpacing.sm),
          ...
          Positioned(
            ...
            child: ScaleTransition(
              scale: _fabScale,
              child: _GlassFAB(isDark: dark, onTap: () => _openNoteEditor()),
            ),
          ),
        ],
      ),
  ...
  Widget _buildBookmarksTab(bool dark) {
    ...
    if (state.hasError) {
      return _TabErrorState(
        ...
        onRetry: () =>
            ref.read(bookmarkControllerProvider.notifier).loadBookmarks(),
      );
    }
...
class _TabLoadingStateState extends State<_TabLoadingState>
  ...
  Widget build(BuildContext context) {
    final baseColor =
        widget.isDark ? const Color(0xFF2C2C2E) : const Color(0xFFE5E5EA);
    return Padding(
          ...
          children: [
            ...
            Text(message,
                style: AppTypography.bodySmall
                    .copyWith(fontFamily: null, color: secColor, height: 1.5),
          ...
          child: Container(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                final segW =
                    (constraints.maxWidth - _padding * 2) / _labels.length;
                    ...
                    children: [
                      Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: accent.withOpacity(dark ? 0.25 : 0.18),
                                  width: 0.5)),
...
class _TypeChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              color: type.color.withOpacity(isDark ? 0.25 : 0.18), width: 0.5)),
      ...
      child: BackdropFilter(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            borderRadius: AppRadius.card,
            border: Border.all(
                color: dark ? const Color(0x1AFFFFFF) : const Color(0x33FFFFFF),
                width: 0.5),
            boxShadow: dark ? AppShadows.darkGlass : AppShadows.lightGlass,
          ),
          child:
                  ...
                  children: [
                    ...
                    if (note.tags.isNotEmpty) ...[
                      ...
                      Wrap(
                          ...
                          children: note.tags
                              .take(3)
                              .map((t) => _TagChip(label: t, isDark: dark))
                              .toList()),
                    ],
                  ]),
            ),
...
class _NoteActionButton extends StatefulWidget {
  ...
  const _NoteActionButton(
      ...
      required this.onTap});
  @override
  State<_NoteActionButton> createState() => _NoteActionButtonState();
}
  ...
  Widget build(BuildContext context) => ScaleTransition(
      ...
      child: GestureDetector(
          ...
          child: ClipRRect(
              ...
              child: BackdropFilter(
                  filter:
                      ImageFilter.blur(sigmaX: AppBlur.lg, sigmaY: AppBlur.lg),
                  child: Container(
                      height: 52,
                      padding:
