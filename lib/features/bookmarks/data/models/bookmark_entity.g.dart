...
extension BookmarkEntityByIndex on IsarCollection<BookmarkEntity> {
  Future<BookmarkEntity?> getByContentId(String contentId) {
    return getByIndex(r'contentId', [contentId]);
  }

  BookmarkEntity? getByContentIdSync(String contentId) {
  ...
  Future<List<BookmarkEntity?>> getAllByContentId(
      List<String> contentIdValues) {
    final values = contentIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'contentId', values);
  }

  List<BookmarkEntity?> getAllByContentIdSync(List<String> contentIdValues) {
    final values = contentIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByContentId(BookmarkEntity object) {
    return putByIndex(r'contentId', object);
  }

  Id putByContentIdSync(BookmarkEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'contentId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByContentId(List<BookmarkEntity> objects) {
    return putAllByIndex(r'contentId', objects);
  }

  List<Id> putAllByContentIdSync(List<BookmarkEntity> objects,
      {bool saveLinks = true}) {
...
extension BookmarkEntityQueryWhereSort
  ...
  QueryBuilder<BookmarkEntity, BookmarkEntity, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension BookmarkEntityQueryWhere
  ...
  QueryBuilder<BookmarkEntity, BookmarkEntity, QAfterWhereClause> typeEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
...
extension BookmarkEntityQuerySortBy
  ...
  QueryBuilder<BookmarkEntity, BookmarkEntity, QAfterSortBy> sortByContentId() {
    return QueryBuilder.apply(this, (query) {
...
extension BookmarkEntityQuerySortThenBy
  ...
  QueryBuilder<BookmarkEntity, BookmarkEntity, QAfterSortBy> thenByContentId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contentId', Sort.asc);
    });
  }
...
extension BookmarkEntityQueryWhereDistinct
  ...
  QueryBuilder<BookmarkEntity, BookmarkEntity, QDistinct> distinctByContentId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension BookmarkEntityQueryProperty
  ...
  QueryBuilder<BookmarkEntity, String, QQueryOperations> contentIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<BookmarkEntity, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
