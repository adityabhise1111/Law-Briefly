...
void _noteEntitySerialize(
  ...
  writer.writeLong(offsets[0], object.charCount);
...
extension NoteEntityQueryFilter
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> charCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> charCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> charCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> isEmptyEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isEmpty',
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> wordCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> wordCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> wordCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteEntityQuerySortBy
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByCharCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'charCount', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByCharCountDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEmpty', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByIsEmptyDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByWordCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wordCount', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByWordCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteEntityQuerySortThenBy
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByCharCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'charCount', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByCharCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'charCount', Sort.desc);
    });
  }
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEmpty', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByIsEmptyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEmpty', Sort.desc);
    });
  }
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByWordCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wordCount', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByWordCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'wordCount', Sort.desc);
    });
  }
...
extension NoteEntityQueryWhereDistinct
  ...
  QueryBuilder<NoteEntity, NoteEntity, QDistinct> distinctByCharCount() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QDistinct> distinctByIsEmpty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QDistinct> distinctByWordCount() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteEntityQueryProperty
  ...
  QueryBuilder<NoteEntity, int, QQueryOperations> charCountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, bool, QQueryOperations> isEmptyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, int, QQueryOperations> wordCountProperty() {
    return QueryBuilder.apply(this, (query) {
