...
class _NoteEditorScreenState extends State<NoteEditorScreen>
  ...
  PreferredSizeWidget _buildAppBar(bool dark, Color accent) => GlassAppBar(
          ...
          child: Row(children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle, color: secColor.withOpacity(0.35))),
            const SizedBox(width: AppSpacing.md),
            ...
            if (widget.existingNote != null)
              Text(
                  'Last edited ${_relativeDate(widget.existingNote!.updatedAt)}',
                  style: AppTypography.caption
                      .copyWith(color: secColor, fontSize: 10.5)),
          ]),
        ),
      );
}
...
class _DlgBtn extends StatefulWidget {
  ...
  const _DlgBtn(
      ...
      required this.onTap});
  @override
  State<_DlgBtn> createState() => _DlgBtnState();
}
