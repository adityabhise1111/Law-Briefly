...
class _LoginScreenState extends State<LoginScreen>
  ...
  void _setupAnimations() {
    ...
    _titleOpacity = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
        parent: _entranceController,
    ...
    _cardOpacity = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
        parent: _entranceController,
...
class _AnimatedBackground extends StatelessWidget {
  ...
  const _AnimatedBackground(
      {required this.isDark, required this.scaleAnimation});
...
class _GlassTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = isDark ? const Color(0x1AFFFFFF) : const Color(0x0D000000);
...
class _GlassGhostButton extends StatefulWidget {
  ...
  @override
  State<_GlassGhostButton> createState() => _GlassGhostButtonState();
}
